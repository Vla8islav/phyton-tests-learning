...
def test_check_if_contact_info_list_matches_an_actual_info(app):
    ...
    contact_info_from_contact_page = app.contact.get_contact_info_from_edit_page(contact_info_from_contact_list.id)
...
#    assert (contact_info_from_contact_page.email3 == contact_info_from_contact_list.email3)
    assert (contact_info_from_contact_page.id == contact_info_from_contact_list.contact_id)
